...
def test_multiple_names():
    assert greet(["test1", "test2", "test3", "test4"]) == "Hello test1, test2, test3, test4."

def test_multiple_shout():
    assert greet("test1", "test2", "TEST3") == "Hello test1 and test2. AND HELLO BRIAN!"

def test_comma_string():
    assert greet("test1", "test2, TEST3") == "Hello test1 and test2. AND HELLO TEST3"

def test_escaped_comma():
    asser greet("test1\, test2") == "Hello test1, test2."